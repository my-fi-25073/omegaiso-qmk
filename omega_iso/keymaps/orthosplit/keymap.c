...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        QK_GESC, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    XXXXXXX, XXXXXXX, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,    KC_DEL,  KC_END,  KC_PGDN,
        MC_LCMD, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    XXXXXXX, XXXXXXX, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,                             
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX, XXXXXXX, KC_N,    KC_M,    LO_COMM, KC_DOT,  PT_SLSH, KC_RSFT,             KC_UP,
        XXXXXXX,          XXXXXXX, MC_LCTL, KC_LALT, KC_SPC,  LOWER,   RAISE,   LOWER,   MC_LCTL, KC_LALT, XXXXXXX,          XXXXXXX,    KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT(
        KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,     KC_PSCR, KC_SCRL, KC_PAUS,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_INS,  KC_HOME, KC_PGUP,
        QK_GESC, XXXXXXX, KC_7,    KC_8,    KC_9,    KC_0,    XXXXXXX, XXXXXXX, KC_GRV,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,    KC_DEL,  KC_END,  KC_PGDN,
        MC_LCMD, XXXXXXX, KC_4,    KC_5,    KC_6,    XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, KC_QUOT,                             
        KC_LSFT, XXXXXXX, KC_1,    KC_2,    KC_3,    XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  XXXXXXX, KC_RSFT,             KC_UP,
        XXXXXXX,          XXXXXXX, MC_LCTL, KC_LALT, XXXXXXX, _______, TO_PT,   _______, MC_LCTL, KC_LALT, XXXXXXX,          XXXXXXX,    KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [2] = LAYOUT(
        KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,     KC_PSCR, KC_SCRL, KC_PAUS,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_INS,  KC_HOME, KC_PGUP,
        QK_GESC, XXXXXXX, KC_F7,   KC_F8,   KC_F9,   KC_F10,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  XXXXXXX, OS_PSCR, KC_DEL,     KC_DEL,  KC_END,  KC_PGDN,
        MC_LCMD, XXXXXXX, KC_F4,   KC_F5,   KC_F6,   KC_F11,  XXXXXXX, XXXXXXX, XXXXXXX, KC_RCTL, KC_RSFT, OS_LANG, KC_RGUI, XXXXXXX,                             
        KC_LSFT, XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F12,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT,             KC_UP,
    ...
    [3] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_INS,  KC_HOME, KC_PGUP,
        KC_ESC,  TO_BA,   GO_UP,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, QK_RBT,  QK_BOOT, EE_CLR,  XXXXXXX, XXXXXXX, KC_DEL,     KC_DEL,  KC_END,  KC_PGDN,
        MC_LCMD, GO_LEFT, XXXXXXX, GO_RGHT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, WO_LEFT, XXXXXXX, XXXXXXX, WO_RGHT, XXXXXXX, XXXXXXX,                             
        KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, VS_BRCK, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, KC_RSFT,             KC_UP,
